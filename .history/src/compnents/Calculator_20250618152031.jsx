    ...
    <>
        <div className="Calculator">
            ...
            <div>
                ...
                <button className='btn-cal'onClick={handleClick()}>)</button>
                <button className='btn-cal'onClick={handleClick()}>AC</button>
                <button className='btn-cal'onClick={handleClick()}><i class="fa-solid fa-delete-left"></i></button> <br />
                <button className='btn-cal'onClick={handleClick()}>7</button> 
                <button className='btn-cal'onClick={handleClick()}>8</button>
                <button className='btn-cal'onClick={handleClick()}>9</button>
