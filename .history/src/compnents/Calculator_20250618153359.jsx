    ...
    <>
        <div className="Calculator">
            ...
            <div className="buttons">
                ...
                <button className='btn-cal'onClick={handleClick('DEL')}><i class="fa-solid fa-delete-left"></i></button> 
                <button className='btn-cal'onClick={handleClick('mod')}>mod</button>
                <button className='btn-cal'onClick={handleClick('exp')}>exp</button>
                <button className='btn-cal'onClick={handleClick('|x|')}>|x|</button>
                <button className='btn-cal'onClick={handleClick('/')}>/</button> 
